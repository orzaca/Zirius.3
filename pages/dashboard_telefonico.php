...
<body>
    ...
    <main class="main-content">
                ...
                <iframe id="barra-lateral" src="/pages/mensajes/telefonico_profile.php" title="Barra Lateral"></iframe>
        ...
        <section class="guion-section" id="guion-section" style="display: none;">
            <iframe id="guion-iframe" src="" width="80%" height="100%" style="border:none; position: absolute; left: 5%; top: 11%;"></iframe>
        </section>

        <section class="manual-section" id="manual-section" style="display: none;">
            <iframe id="manual-iframe" src="" width="80%" height="100%" style="border:none; position: absolute; left: 5%; top: 11%;"></iframe>
        </section>
        ...
        <section class="quejas-section" id="quejas-section" style="display: none;">
            <iframe id="quejas-iframe" src="" width="80%" height="100%" style="border:none; position: absolute; left: 5%; top: 11%;"></iframe>
        </section>

        <section class="wf-section" id="wf-section" style="display: none;">
            <iframe id="wf-iframe" src="" width="70%" height="100%" style="border:none; position: absolute; left: 5%; top: 11%;"></iframe>
        </section>

        <section class="zona-section" id="zona-section" style="display: none;">
            <iframe id="zona-iframe" src="" width="70%" height="100%" style="border:none; position: absolute;left: 5%; top: 11%;"></iframe>
        </section>

        <section class="grilla-section" id="grilla-section" style="display: none;">
            <iframe id="grilla-iframe" src="" width="70%" height="100%" style="border:none; position: absolute; left: 5%; top: 11%;"></iframe>
        </section>
