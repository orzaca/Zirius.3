    ...
    <div class="register-container">
        <div class="register-form">
            ...
            <?php if (!empty($message)) : ?>
                <p class="message<?php echo $message === 'Usuario actualizado exitosamente.' ? ' success' : ''; ?>"><?php echo htmlspecialchars($message); ?></p>
            <?php endif; ?>
            ...
            <p><a href="admin_dashboard.php">Volver al panel de administración</a></p>
        </div>
    </div>
</body>
</html>
