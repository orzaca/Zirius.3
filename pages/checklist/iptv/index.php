...
// Obtener los flujos disponibles (con nombres) desde la tabla 'flows'
$sql_flows = "SELECT * FROM flows4"; // Suponiendo que la tabla 'flows' tiene los flujos con 'id' y 'name'
...
$sql = "SELECT * FROM steps4" . ($flow_filter ? " WHERE flow_id = :flow_id" : "");
