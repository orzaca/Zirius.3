...
<body>
    ...
    <div class="content-wrapper">
        ...
        foreach ($paragraphs as $para) {
            ...
            echo '<button class="copy-btn" onclick="copyText(\'para5' . $para['id'] . '\')">Copiar</button>';// Cambiado a para2
            echo '<button class="edit-btn" onclick="openEditModal5(' . $para['id'] . ')">Modificar</button>';
            echo '</div>';
            echo '</div>';
    ...
    <div id="editModal5"> <!-- Cambiado a editModal3 -->
        <div class="modal-content">
            <span class="close-btn" onclick="closeEditModal5()">&times;</span>
            <h2>Editar Guion</h2>
            <textarea id="editText5" rows="13" maxlength="500"  style="width: 100%;"></textarea>
	         <p id="charCount">Solo puedes escribir hasta 500 caracteres</p>
            <button id="saveChanges5" onclick="saveParagraph5()">Guardar</button> <!-- Cambiado a saveChanges3  -->
        </div>
    </div>
