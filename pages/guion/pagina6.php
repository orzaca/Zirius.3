...
<body>
    ...
    <div class="content-wrapper">
        ...
        foreach ($paragraphs as $para) {
            ...
            echo '<button class="copy-btn" onclick="copyText(\'para6' . $para['id'] . '\')">Copiar</button>';// Cambiado a para2
            echo '<button class="edit-btn"onclick="openEditModal6(' . $para['id'] . ')">Modificar</button>';
            echo '</div>';
            echo '</div>';
        }
        ?>
    ...
    <div id="editModal6"> <!-- Cambiado a editModal3 -->
        <div class="modal-content">
            <span class="close-btn" onclick="closeEditModal6()">&times;</span>
            <h2>Editar Párrafo</h2>
            <textarea id="editText6" rows="13" maxlength="500"  style="width: 100%;"></textarea>
	         <p id="charCount">Solo puedes escribir hasta 500 caracteres</p>
            <button id="saveChanges6" onclick="saveParagraph6()">Guardar</button> <!-- Cambiado a saveChanges3  -->
        </div>
    </div>
